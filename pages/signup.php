...
<head>
    ...
    <title>Sign Up | Local Flashcards</title>
    ...
    <style>
        ...
        .header h1 { font-size: 1.75rem; font-weight: 700; color: #000000; margin-bottom: 0.5rem; }
        .header p { color: #666666; font-size: 0.9rem; }
        .back-btn { display: inline-block; margin-bottom: 1.5rem; background: #ffffff; color: #000000; border: 1px solid #d1d5db; border-radius: 4px; padding: 0.5rem 1rem; text-decoration: none; font-weight: 600; font-size: 0.9rem; transition: background 0.2s; }
        ...
        .success { background: #f0f9ff; border: 1px solid #d1d5db; border-radius: 4px; padding: 1rem; margin-bottom: 1.5rem; color: #000000; }
    </style>
</head>
<body>
    <div class="container">
        <div class="card">
            ...
            <div class="header">
                ...
                <p>Join Local Flashcards and start organizing your study materials</p>
            </div>
